...
public class SkillUpgrade : MonoBehaviour
{
    ...
    [SerializeField] string skillCode;
    ...
    public void OnClick_UpgradeBtn()
    {
        ...
        int idx = PlayerDataMgr.playerData_SO.GetSkillIdxByCode(skillCode);
        currUpgradeDegree = ++PlayerDataMgr.playerData_SO.Skills[idx].upgrade;
        SetUI();
